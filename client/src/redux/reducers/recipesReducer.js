...
const initialState = {
  recipes: [
    {
      id: "97d7346f-afc9-4368-8bdc-903188e8ec8b",
      title: "Milanesa",
      summary:
        "La milanesa es una de las comidas más tradicionales, y también preferidas, de los argentinos. Pese a que las de carne suelen ser más elegidas.",
      healthScore: 2,
      instructions: [
        "Batir los huevos y agregar dentro todos los ingredientes. Mezclar todo muy bien.",
        "Salar las milanesas y colocarlas dentro de la mezcla.",
        "Empanar las milanesas con pan rallado y tratar de que queden bien sujetas.",
        "Freírlas en aceite bien caliente hasta que queden doradas. ",
      ],
    },
    {
      id: "6f8ce31e-00dc-4544-99cd-c3b0512e9616",
      title: "Ratatouille",
      summary:
        "Se suele asociar comer verduras con comer cosas sin gusto, o con poco sabor. Nada más alejado de la realidad y este delicioso Ratatouille viene a demostrarlo!",
      healthScore: 8,
      instructions: [
        "Picar el ajo, la cebolla, el pimiento morrón bien chiquitos.",
        "Cocinar en aceite de oliva, agregar sal. Cuando la cebolla esté transparente agregarle la lata de tomate cubeteado, el tomillo, el laurel y salpimentar. Tapar y dejar cocinar a fuego lento.",
        "Cortar la berenjena, el zucchini y el tomate en rodajas lo más finas y parejas posibles.",
        "Una vez cocida la salsa, triturar.",
        "En una fuente apta para horno, poner la salsa en la base, bien distribuida.",
        "Disponer las rodajas de verdura alternando como en la foto.",
        "Rociar con aceite de oliva por arriba y llevar a un horno precalentado a 150° por el mayor tiempo posible. Una hora y media más o menos, hasta que las verduras queden bien tiernas",
      ],
    },
    {
      vegetarian: true,
